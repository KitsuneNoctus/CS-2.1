...
# import random_ints
# from random import random_ints
import random
...
class IntegerSortTest(unittest.TestCase):
    ...
    def test_sort_on_lists_of_random_integers(self):
        ...
        # items1 = random.sample(range(1, 20), 10)
        items1 = [random.choice(range(1, 20)) for i in range(10)]
        ...
        # items2 = random.sample(range(1, 50), 20)
        items2 = [random.choice(range(1, 50)) for i in range(20)]
        ...
        # items3 = random.sample(range(1, 100), 30)
        items3 = [random.choice(range(1, 100)) for i in range(30)]
    ...
    def test_sort_on_lists_of_random_integers_with_duplicates(self):
        ...
        # items2 = random.sample(range(1, 20), 50)
        items2 = [random.choice(range(1, 20)) for i in range(50)]
        sorted_items2 = sorted(items2)  # Copy
        sort(items2)  # Mutate
        assert items2 == sorted_items2
        ...
        # items3 = random.sample(range(1, 30), 100)
        items3 = [random.choice(range(1, 30)) for i in range(100)]
        sorted_items3 = sorted(items3)  # Copy
        sort(items3)  # Mutate
        assert items3 == sorted_items3
